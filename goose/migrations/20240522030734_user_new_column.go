...
func init() {
	goose.AddMigrationContext(upUserNewColumn, downUserNewColumn)
}

func upUserNewColumn(ctx context.Context, tx *sql.Tx) error {
...
func downUserNewColumn(ctx context.Context, tx *sql.Tx) error {
